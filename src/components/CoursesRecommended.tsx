...
function CoursesRecommended({ courses, onSelect, selectedId }: Props) {
  return (
    <section className="courses-section courses-recommended bg-white">
      <div className="mx-auto w-full max-w-[1920px] bg-[#eaf4ff] px-[40px] py-[70px]">
        ...
        <div className="mt-[28px] grid grid-cols-4 gap-[24px]">
          {courses.map((card, index) => (
            ...
            >
              <span className="course-badge course-badge--hot">Top pick</span>
              ...
              <div className="course-stats mt-[10px]">
                <span className="course-stat">
                  {card.rating ? card.rating.toFixed(1) : "4.8"} rating
                </span>
                <span className="course-stat">
                  {card.students ?? "12k"} learners
                </span>
              </div>
              {card.lessons?.length ? (
        ...
        <div className="mt-[20px] flex justify-end gap-[10px]">
          <button className="grid h-[38px] w-[38px] place-items-center rounded-[8px] bg-[#a9d9d9] text-white transition-all duration-200 hover:bg-[#8bcaca] hover:shadow-[0_12px_24px_rgba(71,185,185,0.35)]">
            <svg
              width="18"
              height="18"
              viewBox="0 0 24 24"
          ...
          <button className="grid h-[38px] w-[38px] place-items-center rounded-[8px] bg-[#47b9b9] text-white transition-all duration-200 hover:bg-[#2aa3b2] hover:shadow-[0_12px_24px_rgba(71,185,185,0.35)]">
            <svg
              width="18"
              height="18"
              viewBox="0 0 24 24"
